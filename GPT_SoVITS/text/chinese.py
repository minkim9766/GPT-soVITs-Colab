...
if __name__ == "__main__":
    text = "?Šâ€”â€”ä½†??€ŠåŽŸç¥žã€‹æ˜¯??ç±³å“ˆ\æ¸¸è‡ªä¸»ï¼Œ?”å‘?„ä?æ¬¾å…¨.?°å??¾ä¸–???’é™©æ¸¸æˆ"
    text = "?£å‘£?£ï½žå°±æ˜¯??¤§äººçš„é¼¹é¼ ?šå§ï¼?
    text = "ä½ å?"
...
# # ç¤ºä¾‹?¨æ³•
# text = "è¿™æ˜¯ä¸€ä¸ªç¤ºä¾‹æ–‡?¬ï¼š,ä½ å?ï¼è¿™???ä¸ªæµ‹è¯?.."
# print(g2p_paddle(text))  # è¾“å‡º: è¿™æ˜¯ä¸€ä¸ªç¤ºä¾‹æ–‡?¬ä½ å¥½è¿™???ä¸ªæµ‹è¯?
